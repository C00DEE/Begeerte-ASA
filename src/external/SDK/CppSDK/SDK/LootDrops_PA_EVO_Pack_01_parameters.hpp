...
struct LootDrops_PA_EVO_Pack_01_C_ExecuteUbergraph_LootDrops_PA_EVO_Pack_01 final
{
public:
	int32                                         EntryPoint;                                        // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_LootDrops_PA_EVO_Pack_01_C_ExecuteUbergraph_LootDrops_PA_EVO_Pack_01;

// Function LootDrops_PA_EVO_Pack_01.LootDrops_PA_EVO_Pack_01_C.UpdateSupplyCrateItems
// 0x0190 (0x0190 - 0x0000)
struct LootDrops_PA_EVO_Pack_01_C_UpdateSupplyCrateItems final
{
public:
	bool                                          LocalFoundExisting;                                // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FConfigSupplyCrateItemsOverride> LocalToAdd;                                       // 0x0008(0x0010)(Edit, BlueprintVisible)
	TArray<struct FSupplyCrateItemSet>            LocalItemSets;                                     // 0x0018(0x0010)(Edit, BlueprintVisible)
	...
	class ATestGameMode_C*                        K2Node_DynamicCast_AsTest_Game_Mode;               // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_59[0x7];                                       // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FConfigSupplyCrateItemsOverride        CallFunc_Array_Get_Item;                           // 0x0060(0x0038)()
	...
	struct FConfigSupplyCrateItemsOverride        CallFunc_Array_Get_Item_1;                         // 0x00B0(0x0038)()
	...
	class AGameModeBase*                          CallFunc_GetGameMode_ReturnValue_1;                // 0x00F8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class ATestGameMode_C*                        K2Node_DynamicCast_AsTest_Game_Mode_1;             // 0x0100(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FConfigSupplyCrateItemsOverride        CallFunc_Array_Get_Item_2;                         // 0x0110(0x0038)()
	...
	struct FConfigSupplyCrateItemsOverride        K2Node_MakeStruct_ConfigSupplyCrateItemsOverride;  // 0x0150(0x0038)()
...
DUMPER7_ASSERTS_LootDrops_PA_EVO_Pack_01_C_UpdateSupplyCrateItems;
