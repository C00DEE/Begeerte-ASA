...
public:
	...
	bool                                          CallFunc_IsCarriedAsPassenger_ReturnValue;         // 0x01F1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1F2[0x6];                                      // 0x01F2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class APrimalDinoCharacter*                   CallFunc_GetRidingDino_ReturnValue;                // 0x01F8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_1;                    // 0x0200(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsShooterCharacter_ReturnValue;           // 0x0201(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_WyvProjFireBall_C_BP_IgnoreProjectileImpact;
...
DUMPER7_ASSERTS_WyvProjFireBall_C_GetSocketForFinalTraceCheckFromInstigatorToDirectDamageVictim;
